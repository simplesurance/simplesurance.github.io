...
export default class Post extends Component {
  ...
  componentDidMount () {
    this.requestAuthorData().then(data => {

      this.setState({ author: data })
    })
  }

  requestAuthorData = async (username = 'atilafassina') => {
...
// const Post = ({ children }) => {
//   const author = requestAuthorData('atilafassina')
//   author.then( data => this.setState(data))
//   return (
//     <Main>
//       <script src="/static/vendor/prism.js"></script>
//       <article className="postWrapper">
